============================================================
A21S BLUETOOTH / AUDIO ANALYSIS
============================================================
DATE: Wed 08/19/2026 15:37:21.27

[1] WORK DIRECTORY
============================================================
 Volume in drive C is 19045_7417_X64_MUI
 Volume Serial Number is 8E1B-9445

 Directory of C:\Users\mobina\Desktop\desktop\a217 roms\A21S_VENDOR_WORK

08/19/2026  03:37 PM    <DIR>          .
08/19/2026  03:37 PM    <DIR>          ..
08/19/2026  03:37 PM                 0 A21S_ANALYSIS.txt
08/19/2026  03:36 PM    <DIR>          python
08/19/2026  03:36 PM    <DIR>          sdat2img
08/19/2026  03:24 PM       293,994,496 vendor.img
               2 File(s)    293,994,496 bytes
               4 Dir(s)  175,295,336,448 bytes free
...
08/19/2026  03:24 PM       293,994,496 vendor.img
               1 File(s)    293,994,496 bytes
               0 Dir(s)  175,295,336,448 bytes free
...
INFO: Could not find "2>&1".

--- ADB ---
C:\Program Files (x86)\ADB and Fastboot++\adb.exe
INFO: Could not find "2>&1".
...
[5] VENDOR IMAGE FILE TYPE
============================================================
/c/Users/mobina/Desktop/desktop/a217 roms/A21S_VENDOR_WORK/vendor.img: Linux rev 1.0 ext2 filesystem data, UUID=bdc8b5f4-cd74-5598-943a-9064fc25dd48, volume name "vendor" (extents) (large files) (huge files)

[6] VENDOR IMAGE HEADER
============================================================
...
[7] SEARCH FOR BLUETOOTH STRINGS
============================================================
/usr/bin/bash: line 1: strings: command not found

[8] SEARCH FOR A21S BLUETOOTH FILE NAMES
============================================================
/usr/bin/bash: line 1: strings: command not found
...
[bluetooth.device.default_name]: [Galaxy A21s]
...
[cache_key.bluetooth.bluetooth_adapter_get_connection_state]: [1852009668026693628]
[cache_key.bluetooth.bluetooth_adapter_get_profile_connection_state]: [1852009668026693630]
[cache_key.bluetooth.bluetooth_adapter_get_state]: [1852009668026693622]
[cache_key.bluetooth.bluetooth_adapter_is_offloaded_filtering_supported]: [1852009668026693610]
[cache_key.bluetooth.bluetooth_device_get_bond_state]: [1852009668026693615]
[cache_key.bluetooth.bluetooth_map_get_connection_state]: [1852009668026693618]
[cache_key.bluetooth.bluetooth_sap_get_connection_state]: [1852009668026693619]
[debug.tracing.battery_stats.audio]: [0]
[init.svc.audioserver]: [running]
[init.svc.vendor.audio-hal]: [running]
[init.svc.vendor.bluetooth-1-0]: [running]
[init.svc_debug_pid.audioserver]: [4876]
[init.svc_debug_pid.vendor.audio-hal]: [4824]
[init.svc_debug_pid.vendor.bluetooth-1-0]: [4832]
[log.tag.APM_AudioPolicyManager]: [D]
[net.bt.name]: [Android]
[persist.bluetooth.a2dp.multiple]: [true]
[persist.bluetooth.a2dp.multiple_devices]: [true]
...
[persist.bluetooth.enable_dual_mode_audio]: [true]
[persist.bluetooth.mapversion]: [map14]
[persist.bluetooth.maxconnectedaudiodevices]: []
[persist.bluetooth.showdeviceswithoutnames]: [false]
[persist.bluetooth.snooplogfilter.profiles.map]: [disabled]
[persist.bluetooth.snooplogfilter.profiles.pbap]: [disabled]
[persist.log.tag.bluetooth]: []
[persist.vendor.bluetooth.a2dp.multiple]: [true]
[ro.boottime.audioserver]: [17429554025]
[ro.boottime.vendor.audio-hal]: [17237325756]
[ro.boottime.vendor.bluetooth-1-0]: [17252388333]
[ro.bt.bdaddr_path]: [/mnt/vendor/efs/bluetooth/bt_addr]
[sys.fuse.transcode_enabled]: [true]

[12] AUDIO POLICY FILES ON PHONE
============================================================
...
Bluetooth Status
  ...
  name: Galaxy A21s
  time since enabled: 00:48:15.210
...
Scan Mode Changes:
    08-19 14:52:05.894 (processProfileServiceStateChanged) SCAN_MODE_CONNECTABLE
...
AdapterState:
 total records=4
 rec[0]: time=08-19 14:52:05.587 processed=OffState org=OffState dest=TurningBleOnState what=3(0x3) BLE_TURN_ON
 rec[1]: time=08-19 14:52:05.689 processed=TurningBleOnState org=TurningBleOnState dest=BleOnState what=7(0x7) BLE_STARTED
 rec[2]: time=08-19 14:52:05.694 processed=BleOnState org=BleOnState dest=TurningOnState what=1(0x1) USER_TURN_ON
 rec[3]: time=08-19 14:52:05.962 processed=TurningOnState org=TurningOnState dest=OnState what=5(0x5) BREDR_STARTED
curState=OnState
...
Profile: A2dpService
  ...
  === A2dpStateMachine for XX:XX:XX:XX:F5:5E (Active) ===
    ...
    StateMachineLog:
      A2dpStateMachine:
       total records=5
       rec[0]: time=08-19 14:52:06.061 processed=Disconnected org=Disconnected dest=Connecting what=1(0x1) CONNECT: arg1=0, arg2=0, obj=null
       rec[1]: time=08-19 14:52:27.742 processed=Connecting org=Connecting dest=<null> what=101(0x65) STACK_EVENT: arg1=0, arg2=0, obj=A2dpStackEvent {type:EVENT_TYPE_CONNECTION_STATE_CHANGED, device:XX:XX:XX:XX:F5:5E, value1:CONNECTING}
       rec[2]: time=08-19 14:52:29.691 processed=Connecting org=Connecting dest=<null> what=101(0x65) STACK_EVENT: arg1=0, arg2=0, obj=A2dpStackEvent {type:EVENT_TYPE_CODEC_CONFIG_CHANGED, device:XX:XX:XX:XX:F5:5E, value1:0, codecStatus:{mCodecConfig:{codecName:AAC,mCodecType:1,mCodecPriority:2001,mSampleRate:0x1(44100),mBitsPerSample:0x1(16),mChannelMode:0x2(STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0},mCodecsLocalCapabilities:[{codecName:LDAC,mCodecType:4,mCodecPriority:5001,mSampleRate:0xf(44100|48000|88200|96000),mBitsPerSample:0x7(16|24|32),mChannelMode:0x2(STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}, {codecName:aptX HD,mCodecType:3,mCodecPriority:4001,mSampleRate:0x3(44100|48000),mBitsPerSample:0x2(24),mChannelMode:0x2(STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}, {codecName:aptX,mCodecType:2,mCodecPriority:3001,mSampleRate:0x3(44100|48000),mBitsPerSample:0x1(16),mChannelMode:0x2(STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}, {codecName:AAC,mCodecType:1,mCodecPriority:2001,mSampleRate:0x1(44100),mBitsPerSample:0x1(16),mChannelMode:0x2(STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}, {codecName:SBC,mCodecType:0,mCodecPriority:1001,mSampleRate:0x1(44100),mBitsPerSample:0x1(16),mChannelMode:0x3(MONO|STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}],mCodecsSelectableCapabilities:[{codecName:AAC,mCodecType:1,mCodecPriority:2001,mSampleRate:0x1(44100),mBitsPerSample:0x1(16),mChannelMode:0x2(STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}, {codecName:SBC,mCodecType:0,mCodecPriority:1001,mSampleRate:0x1(44100),mBitsPerSample:0x1(16),mChannelMode:0x3(MONO|STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}]}}
       rec[3]: time=08-19 14:52:29.734 processed=Connecting org=Connecting dest=Connected what=101(0x65) STACK_EVENT: arg1=0, arg2=0, obj=A2dpStackEvent {type:EVENT_TYPE_CONNECTION_STATE_CHANGED, device:XX:XX:XX:XX:F5:5E, value1:CONNECTED}
       rec[4]: time=08-19 14:52:29.787 processed=Connected org=Connected dest=<null> what=101(0x65) STACK_EVENT: arg1=0, arg2=0, obj=A2dpStackEvent {type:EVENT_TYPE_CODEC_CONFIG_CHANGED, device:XX:XX:XX:XX:F5:5E, value1:0, codecStatus:{mCodecConfig:{codecName:AAC,mCodecType:1,mCodecPriority:2001,mSampleRate:0x1(44100),mBitsPerSample:0x1(16),mChannelMode:0x2(STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0},mCodecsLocalCapabilities:[{codecName:LDAC,mCodecType:4,mCodecPriority:5001,mSampleRate:0xf(44100|48000|88200|96000),mBitsPerSample:0x7(16|24|32),mChannelMode:0x2(STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}, {codecName:aptX HD,mCodecType:3,mCodecPriority:4001,mSampleRate:0x3(44100|48000),mBitsPerSample:0x2(24),mChannelMode:0x2(STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}, {codecName:aptX,mCodecType:2,mCodecPriority:3001,mSampleRate:0x3(44100|48000),mBitsPerSample:0x1(16),mChannelMode:0x2(STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}, {codecName:AAC,mCodecType:1,mCodecPriority:2001,mSampleRate:0x1(44100),mBitsPerSample:0x1(16),mChannelMode:0x2(STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}, {codecName:SBC,mCodecType:0,mCodecPriority:1001,mSampleRate:0x1(44100),mBitsPerSample:0x1(16),mChannelMode:0x3(MONO|STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}],mCodecsSelectableCapabilities:[{codecName:AAC,mCodecType:1,mCodecPriority:2001,mSampleRate:0x1(44100),mBitsPerSample:0x1(16),mChannelMode:0x2(STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}, {codecName:SBC,mCodecType:0,mCodecPriority:1001,mSampleRate:0x1(44100),mBitsPerSample:0x1(16),mChannelMode:0x3(MONO|STEREO),mCodecSpecific1:0,mCodecSpecific2:0,mCodecSpecific3:0,mCodecSpecific4:0}]}}
      curState=Connected
...
Profile: AvrcpTargetService:
  ...
  BTAudio Active Player Events:
    08-19 14:52:06.570 setActivePlayer(): setting player to org.telegram.messenger.web
  ...
  AvrcpVolumeManager:
    ...
    BTAudio Volume Events:
      08-19 14:52:30.072 setVolume: device=XX:XX:XX:XX:F5:5E avrcpVolume=80 deviceVolume=16 mDeviceMaxVolume=25
      08-19 14:52:30.282 switchVolumeDevice: Updating device volume: avrcpVolume=81
      08-19 14:52:30.289 switchVolumeDevice: Updating device volume: avrcpVolume=81
      08-19 14:52:30.336 storeVolume: Storing stream volume level for device XX:XX:XX:XX:F5:5E : 16
...
Profile: HeadsetService
  ...
  ==== StateMachine for XX:XX:XX:XX:F5:5E ====
    ...
    mSpeakerVolume: 15
    mMicVolume: 9
    mConnectingTimestampMs(uptimeMillis): 245885
    ...
    StateMachineLog:
      HeadsetStateMachine:
       total records=78
       rec[0]: time=08-19 15:23:59.720 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength4, batteryCharge=4]
       rec[1]: time=08-19 15:24:36.843 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength5, batteryCharge=4]
       rec[2]: time=08-19 15:25:43.401 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength4, batteryCharge=4]
       rec[3]: time=08-19 15:26:05.162 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength5, batteryCharge=4]
       rec[4]: time=08-19 15:28:59.242 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength4, batteryCharge=4]
       rec[5]: time=08-19 15:29:03.078 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength5, batteryCharge=4]
       rec[6]: time=08-19 15:30:13.482 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength4, batteryCharge=4]
       rec[7]: time=08-19 15:30:19.881 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength5, batteryCharge=4]
       rec[8]: time=08-19 15:31:07.244 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength4, batteryCharge=4]
       rec[9]: time=08-19 15:31:13.638 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength5, batteryCharge=4]
       rec[10]: time=08-19 15:31:57.160 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength4, batteryCharge=4]
       rec[11]: time=08-19 15:32:21.481 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength5, batteryCharge=4]
       rec[12]: time=08-19 15:32:50.922 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength4, batteryCharge=4]
       rec[13]: time=08-19 15:32:56.042 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength5, batteryCharge=4]
       rec[14]: time=08-19 15:33:08.846 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength4, batteryCharge=4]
       rec[15]: time=08-19 15:33:39.731 processed=Connected org=Connected dest=<null> what=101(0x65) STACK_EVENT: arg1=0, arg2=0, obj=EVENT_TYPE_BIEV[19], valInt=2, valInt2=45, valString=null, valObject=null, device=XX:XX:XX:XX:F5:5E
       rec[16]: time=08-19 15:33:44.683 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength5, batteryCharge=4]
       rec[17]: time=08-19 15:33:53.832 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength4, batteryCharge=4]
       rec[18]: time=08-19 15:34:15.441 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength4, batteryCharge=5]
       rec[19]: time=08-19 15:34:37.162 processed=Connected org=Connected dest=<null> what=10(0xa) DEVICE_STATE_CHANGED: arg1=0, arg2=0, obj=HeadsetDeviceState[hasCellularService=1, isRoaming=0, signalStrength5, batteryCharge=5]
      curState=Connected
...
Profile: BluetoothMapService
  mRemoteDevice: null
  mState: 0
  mAppObserver: com.android.bluetooth.map.BluetoothMapAppObserver@96e33f5
...
Connection Events:
  08-19 14:52:33.903 CONNECTED    xx:xx:xx:xx:f5:5e
  08-19 14:52:33.903 CONNECTED    xx:xx:xx:xx:f5:5e
  08-19 14:52:33.903 CONNECTED    xx:xx:xx:xx:f5:5e
...
Socket Events: 
  ...
  14:52:05.804	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	5         	RFCOMM	
  14:52:05.806	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	-2         	L2CAP	
  14:52:05.807	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	4099         	L2CAP	
  14:52:05.818	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	-2         	RFCOMM	
  14:52:05.818	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	6         	RFCOMM	
  14:52:05.821	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	-2         	L2CAP	
  14:52:05.821	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	4101         	L2CAP	
  14:52:06.057	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	-2         	RFCOMM	
  14:52:06.058	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	7         	RFCOMM	
  14:52:06.077	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	-2         	RFCOMM	
  14:52:06.078	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	8         	RFCOMM	
  14:52:06.082	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	-2         	L2CAP	
  14:52:06.083	00:00:00:00:00:00	STATE_LISTENING   	ROLE_LISTEN      	4103         	L2CAP	
  14:52:30.716	xx:xx:xx:xx:f5:5e	STATE_CONNECTING   	ROLE_CONNECTION      	-1         	RFCOMM	aeac4a03-dff5-498f-843a-34487cf133eb
  14:52:30.843	xx:xx:xx:xx:f5:5e	STATE_CONNECTED   	ROLE_CONNECTION      	6         	RFCOMM	aeac4a03-dff5-498f-843a-34487cf133eb
  14:59:16.439	xx:xx:xx:xx:f5:5e	STATE_DISCONNECTED   	ROLE_CONNECTION      	6         	RFCOMM	aeac4a03-dff5-498f-843a-34487cf133eb
...
stack::gatt    2026-08-19 14:52:33.903 xx:xx:xx:xx:f5:5e, BT_TRANSPORT_BR_EDR, state: GATT_CH_CFG, No ACL holders
stack::gatt    2026-08-19 14:52:33.903 xx:xx:xx:xx:f5:5e, BT_TRANSPORT_BR_EDR, state: GATT_CH_OPEN, No ACL holders
...
BTA_GATTC_CB state BTA_GATTC_STATE_ENABLED 
 ...
 ->cl_rcb (BTA_GATTC_CL_MAX=32)
  client_if: 4  app uuids: 99d06bc8-6ba9-d50f-de4d-0995bd61e2a8  clcb_num: 0
  client_if: 5  app uuids: 932d7217-a03d-d2c1-54d6-36b58718b531  clcb_num: 0
  client_if: 6  app uuids: 8c1b5247-295e-dd0d-25aa-46e8b5688601  clcb_num: 0
  -- used: 3
...
Bluetooth Wakelock Statistics:
  Is acquired                    : false
  Acquired/released count        : 3 / 3
  Acquired/released error count  : 0 / 0
  Last acquire/release error code: 0 / 0
  Last acquired time (ms)        : 3679
  Acquired time min/max/avg (ms) : 13 / 3679 / 1238
  Total acquired time (ms)       : 3714
  Total run time (ms)            : 2685857
...
shim::legacy::bta::dm    2026-08-19 14:52:30.712 state:       BTA_DM_SEARCH_IDLE event:BTA_DM_API_SEARCH_CANCEL_EVT
...
shim::legacy::l2cap   active channel lcid:0x0042 rcid:0x01a0 is_ecoc:false in_use:true
shim::legacy::l2cap   active channel lcid:0x0043 rcid:0x01a1 is_ecoc:false in_use:true
shim::legacy::l2cap   active channel lcid:0x0045 rcid:0x01a3 is_ecoc:false in_use:true
shim::legacy::l2cap   active channel lcid:0x0048 rcid:0x01a6 is_ecoc:false in_use:true
shim::legacy::l2cap   active channel lcid:0x004a rcid:0x01a8 is_ecoc:false in_use:true
 ----- shim::btm -----
shim::btm  2026-08-19 14:52:05.621 Initialized btm history
shim::btm  2026-08-19 14:52:05.742 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:2 scn:2 dlci:4 mtu:990
shim::btm  2026-08-19 14:52:05.760 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:3 scn:3 dlci:6 mtu:256
shim::btm  2026-08-19 14:52:05.760 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:4 scn:4 dlci:8 mtu:256
shim::btm  2026-08-19 14:52:05.760 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:5 scn:3 dlci:6 mtu:256
shim::btm  2026-08-19 14:52:05.761 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:6 scn:4 dlci:8 mtu:256
shim::btm  2026-08-19 14:52:05.761 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:7 scn:3 dlci:6 mtu:256
shim::btm  2026-08-19 14:52:05.761 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:8 scn:4 dlci:8 mtu:256
shim::btm  2026-08-19 14:52:05.762 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:9 scn:3 dlci:6 mtu:256
shim::btm  2026-08-19 14:52:05.762 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:10 scn:4 dlci:8 mtu:256
shim::btm  2026-08-19 14:52:05.762 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:11 scn:3 dlci:6 mtu:256
shim::btm  2026-08-19 14:52:05.762 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:12 scn:4 dlci:8 mtu:256
shim::btm  2026-08-19 14:52:05.763 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:13 scn:3 dlci:6 mtu:256
shim::btm  2026-08-19 14:52:05.763 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:14 scn:4 dlci:8 mtu:256
shim::btm  2026-08-19 14:52:05.792 PAN    Registered               : 00:00:00:00:00:00 
shim::btm  2026-08-19 14:52:05.793 PAN    Role change              : 00:00:00:00:00:00 role:0x5
shim::btm  2026-08-19 14:52:05.804 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:15 scn:5 dlci:10 mtu:990
shim::btm  2026-08-19 14:52:05.818 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:16 scn:6 dlci:12 mtu:990
shim::btm  2026-08-19 14:52:05.895 SCAN   Classic updated          : 00:00:00:00:00:00 inquiry_scan_enable:F page_scan_enable:F
shim::btm  2026-08-19 14:52:05.895 SCAN   Classic updated          : 00:00:00:00:00:00 inquiry_scan_enable:F page_scan_enable:T
shim::btm  2026-08-19 14:52:06.007 RFCOMM Server stopped           : 00:00:00:00:00:00 handle:3 scn:3 dlci:6 is_server:true
shim::btm  2026-08-19 14:52:06.007 RFCOMM Server stopped           : 00:00:00:00:00:00 handle:4 scn:4 dlci:8 is_server:true
shim::btm  2026-08-19 14:52:06.007 ACL    Initiated connection     : xx:xx:xx:xx:f5:5e classic
shim::btm  2026-08-19 14:52:06.058 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:17 scn:7 dlci:14 mtu:990
shim::btm  2026-08-19 14:52:06.078 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:18 scn:8 dlci:16 mtu:990
shim::btm  2026-08-19 14:52:27.730 ACL    Connection failed        : xx:xx:xx:xx:f5:5e classic reason:CONNECTION_TIMEOUT(0x08)
shim::btm  2026-08-19 14:52:27.732 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:19 scn:3 dlci:6 mtu:256
shim::btm  2026-08-19 14:52:27.733 RFCOMM Server started           : ff:ff:ff:ff:ff:ff handle:20 scn:4 dlci:8 mtu:256
shim::btm  2026-08-19 14:52:27.741 ACL    Initiated connection     : xx:xx:xx:xx:f5:5e classic
shim::btm  2026-08-19 14:52:29.426 ACL    Connection successful    : xx:xx:xx:xx:f5:5e classic Local initiated
shim::btm  2026-08-19 14:52:29.427 ACL    Role change              : xx:xx:xx:xx:f5:5e classic New_role:CENTRAL(0x00) status:SUCCESS(0x00)
shim::btm  2026-08-19 14:52:29.573 SEC    Encryption success       : xx:xx:xx:xx:f5:5e status:HCI_SUCCESS transport:BT_TRANSPORT_BR_EDR is_encrypted:T
shim::btm  2026-08-19 14:52:29.731 A2DP   Stream opened            : xx:xx:xx:xx:f5:5e BTA_AV_OPEN_EVT(0x2)
shim::btm  2026-08-19 14:52:30.712 API    Cancel discovery         : 00:00:00:00:00:00 
shim::btm  2026-08-19 14:52:30.785 RFCOMM Connection opened        : xx:xx:xx:xx:f5:5e handle:21 scn:6 dlci:12 mtu:990
shim::btm  2026-08-19 14:52:33.963 RFCOMM Server stopped           : 00:00:00:00:00:00 handle:5 scn:3 dlci:6 is_server:true
shim::btm  2026-08-19 14:52:42.879 ACL    Power mode change        : xx:xx:xx:xx:f5:5e immediate:sniff[0x02] ==> immediate:active[0x00]
shim::btm  2026-08-19 14:54:21.745 ACL    Power mode change        : xx:xx:xx:xx:f5:5e immediate:sniff[0x02] ==> immediate:active[0x00]
shim::btm  2026-08-19 14:59:16.439 RFCOMM Connection closed        : xx:xx:xx:xx:f5:5e handle:21 scn:6 dlci:12 is_server:false
shim::btm  2026-08-19 15:11:31.236 ACL    Power mode change        : xx:xx:xx:xx:f5:5e immediate:sniff[0x02] ==> immediate:active[0x00]
shim::btm  2026-08-19 15:23:50.229 ACL    Power mode change        : xx:xx:xx:xx:f5:5e immediate:sniff[0x02] ==> immediate:active[0x00]
shim::btm  2026-08-19 15:33:39.722 ACL    Power mode change        : xx:xx:xx:xx:f5:5e immediate:sniff[0x02] ==> immediate:active[0x00]
shim::btm  2026-08-19 15:33:47.234 ACL    Power mode change        : xx:xx:xx:xx:f5:5e immediate:active[0x00] ==> immediate:sniff[0x02]
 ...
 ----- Filtering as Developer -----
{
  ...
  wakelock_manager_data: {
    ...
    last_acquired_timestamp_millis: 299,
    last_released_timestamp_millis: 217442,
    last_interval_millis: 299,
    max_interval_millis: 299,
    min_interval_millis: 299,
    avg_interval_millis: 299,
    total_interval_millis: 299,
    total_time_since_reset_millis: 2710403
  },
  shim_dumpsys_data: {
    title: "----- Shim Dumpsys -----",
...
Output thread 0x738b673880, name AudioOut_D, tid 5056, type 0 (MIXER):
  ...
  Timestamp stats: n=358 disc=3 cold=0 nRdy=0 err=26 rate=0.969398 jitterMs(ave=0.66224 std=9.00695 min=-0.138961 max=130.875) localSR(46700.1, 0.000691642) correctedJitterMs(ave=0.805005 std=2.44513 min=-0.172231 max=19.7704)
  Timestamp corrected: no
  Last write occurred (msecs): 2697250
  Process time ms stats: ave=0.457219 std=0.296804 min=0.241846 max=1.63519
  Hal write jitter ms stats: ave=-0.00328034 std=0.2791 min=-0.932077 max=0.963808
  Threadloop write latency stats: ave=-454.902 std=9286.84 min=-158920 max=99.6191
...
Audio Stream Out(2)::dump
	...
	output backend_mode: 0
      Signal power history (resolution: 1000.0 ms):
       ...
       08-19 14:52:14.760: [  -31.1 ] sum(18.8)
      Signal power history (resolution: 50.0 ms):
       ...
       08-19 14:52:14.760: [  -21.6  -24.8  -24.7  -29.0  -33.4  -37.4  -41.5  -45.7  -49.7  -53.5
       08-19 14:52:15.260:    -57.8  -61.9  -66.8  -71.1  -78.5 ] sum(18.8)
...
Supported latency modes: { }
  Stream volumes in dB: 0:-42, 1:-inf, 2:-inf, 3:0, 4:-8, 5:-inf, 6:-42, 7:-11, 8:-6, 9:-96, 10:0, 11:0, 12:0, 13:0, 14:0
  ...
  1 Tracks of which 0 are active
    Type     Id Active Client Session Port Id S  Flags   Format Chn mask  SRate ST Usg CT  G db  L dB  R dB  VS dB  PortVol dB   Server FrmCnt  FrmRdy F Underruns  Flushed BitPerfect InternalMute   Latency
             69     no   4876       0       0 I  0x000 00000005 00000003  44100 13   f  0  -inf     0     0     0            0 00000000   2652       0 I         0        0      false        false       new
  0 Effect Chains
  Local log:
   ...
   08-19 14:52:03.609 CFG_EVENT_CREATE_AUDIO_PATCH: old device 0x1 (AUDIO_DEVICE_OUT_EARPIECE) new device 0x1 (AUDIO_DEVICE_OUT_EARPIECE)
   08-19 14:52:04.787 CFG_EVENT_CREATE_AUDIO_PATCH: old device 0x1 (AUDIO_DEVICE_OUT_EARPIECE) new device 0x1 (AUDIO_DEVICE_OUT_EARPIECE)
   08-19 14:52:04.887 CFG_EVENT_CREATE_AUDIO_PATCH: old device 0x1 (AUDIO_DEVICE_OUT_EARPIECE) new device 0x1 (AUDIO_DEVICE_OUT_EARPIECE)
   08-19 14:52:05.143 CFG_EVENT_CREATE_AUDIO_PATCH: old device 0x1 (AUDIO_DEVICE_OUT_EARPIECE) new device 0x1 (AUDIO_DEVICE_OUT_EARPIECE)
   08-19 14:52:05.248 CFG_EVENT_CREATE_AUDIO_PATCH: old device 0x1 (AUDIO_DEVICE_OUT_EARPIECE) new device 0x1 (AUDIO_DEVICE_OUT_EARPIECE)
   08-19 14:52:05.984 removeTrack_l (0x72d0d50360)          65     no   4876       0       0 T  0x000 00000005 00000003  44100 13   f  0  -inf     0     0     0            0 00000000   2652       0 I         0        0      false        false       new
   08-19 14:52:06.075 CFG_EVENT_CREATE_AUDIO_PATCH: old device 0x1 (AUDIO_DEVICE_OUT_EARPIECE) new device 0x1 (AUDIO_DEVICE_OUT_EARPIECE)
   08-19 14:52:14.651 CFG_EVENT_CREATE_AUDIO_PATCH: old device 0x1 (AUDIO_DEVICE_OUT_EARPIECE) new device 0x1 (AUDIO_DEVICE_OUT_EARPIECE)
   08-19 14:52:14.661 AT::add       (0x72d0d509e0)          67     no   5094     417      45 A  0x000 00000001 00000003  48000  0   2  1  -inf     0     0     0          -42 00000000  24000       0 f         0        0      false        false       new
   08-19 14:52:15.582 AT::remove    (0x72d0d509e0)          67     no   5094     417      45 S  0x600 00000001 00000003  48000  0   2  1     0     0     0     0          -42 00008CA0  24000       0 f         0        0      false        false   88.03 k
   08-19 14:52:15.598 removeTrack_l (0x72d0d509e0)          67     no   5094     417      45 T  0x600 00000001 00000003  48000  0   2  1     0     0     0     0          -42 00008CA0  24000       0 f         0        0      false        false   88.03 k
   08-19 14:52:15.832 CFG_EVENT_CREATE_AUDIO_PATCH: old device 0x1 (AUDIO_DEVICE_OUT_EARPIECE) new device 0x1 (AUDIO_DEVICE_OUT_EARPIECE)
...
HAL does not support Bluetooth latency modes
Supported latency modes: { }
  Stream volumes in dB: 0:-24, 1:-inf, 2:-inf, 3:-5.1, 4:-8, 5:-inf, 6:-24, 7:-inf, 8:0, 9:0, 10:-5.9, 11:-5.9, 12:0, 13:0, 14:0
  Normal mixer raw underrun counters: partial=0 empty=0
  0 Tracks
  0 Effect Chains
  Local log:
...
Output thread 0x738b393880, name AudioOut_1D, tid 5063, type 0 (MIXER):
  ...
  Input device: 0 (AUDIO_DEVICE_NONE)
  Audio source: 0 (AUDIO_SOURCE_DEFAULT)
  Timestamp stats: n=548 disc=1 cold=0 nRdy=0 err=3 rate=0.99999 jitterMs(ave=0.000107225 std=0.0864645 min=-1.39492 max=1.28027) localSR(47999.8, 2.53706e-09) correctedJitterMs(ave=0.000191565 std=0.00819177 min=-0.0221803 max=0.0511023)
  Timestamp corrected: no
  Last write occurred (msecs): 2733299
  Master volume: 1.000000
  Master mute: off
  Mixer channel Mask: 0x3 (front-left, front-right)
  Normal frame count: 960
...
HAL does not support Bluetooth latency modes
Supported latency modes: { }
  Stream volumes in dB: 0:0, 1:-inf, 2:-inf, 3:0, 4:-8, 5:-inf, 6:-42, 7:-11, 8:0, 9:0, 10:0, 11:0, 12:0, 13:0, 14:0
  Normal mixer raw underrun counters: partial=0 empty=0
  1 Tracks of which 0 are active
    Type     Id Active Client Session Port Id S  Flags   Format Chn mask  SRate ST Usg CT  G db  L dB  R dB  VS dB  PortVol dB   Server FrmCnt  FrmRdy F Underruns  Flushed BitPerfect InternalMute   Latency
...
Output thread 0x7387acc880, name AudioOut_75, tid 14921, type 0 (MIXER):
  I/O handle: 117
  Standby: yes
  ...
  Fast track availMask=0xfe
  Standby delay ns=3000000000
  AudioStreamOut: 0x7160d65f50 flags 0 (AUDIO_OUTPUT_FLAG_NONE)
  Frames written: 0
  Suspended frames: 0
  ...
  Master mono: off
  Master balance: 0.000000 (0.000000)
  FastMixer thread 0x73898137c0 tid=14920  FastMixer command=COLD_IDLE writeSequence=0 framesWritten=0
...
HAL does not support Bluetooth latency modes
Supported latency modes: { }
  Stream volumes in dB: 0:-42, 1:-inf, 2:-inf, 3:-inf, 4:-14, 5:-inf, 6:-42, 7:-27, 8:-inf, 9:-96, 10:-15, 11:-14, 12:0, 13:0, 14:0
  Normal mixer raw underrun counters: partial=0 empty=0
  1 Tracks of which 0 are active
    Type     Id Active Client Session Port Id S  Flags   Format Chn mask  SRate ST Usg CT  G db  L dB  R dB  VS dB  PortVol dB   Server FrmCnt  FrmRdy F Underruns  Flushed BitPerfect InternalMute   Latency
             68     no   4876       0       0 I  0x000 00000005 00000003  44100 13   f  0  -inf     0     0     0            0 00000000   3072       0 I         0        0      false        false       new
  1 Effect Chains
    1 effects for session 0
	In buffer                   Out buffer                     Active tracks:
	0x7270d70f00 -> 0x738b85b000   0x738b85b000 -> 0x7270d70f00   0
	Effect ID 11:
		...
		- Input configuration:
			...
			0x738b85b000 01024   44100    00000003      5 (AUDIO_FORMAT_PCM_FLOAT)
		- Output configuration:
			Buffer     Frames  Smp rate Channels Format
			0x738b85b000 01024   44100    00000003      5 (AUDIO_FORMAT_PCM_FLOAT)
		- HAL buffers:
			In(0x7270d70f00 -> 0x738b85b000) InConversion(nullptr) Out(0x738b85b000 -> 0x7270d70f00) OutConversion(nullptr)
	Effect ID 11 HAL dump:
  Local log:
   08-19 14:52:30.183 CFG_EVENT_CREATE_AUDIO_PATCH: old device  (Empty device types) new device 0x80 (AUDIO_DEVICE_OUT_BLUETOOTH_A2DP)

Output thread 0x7387a65830, name AudioOut_7D, tid 14925, type 2 (DUPLICATING):
  I/O handle: 125
  Standby: yes
  Sample rate: 44100 Hz
  HAL frame count: 1014
...
Supported latency modes: { LOW }
  2 OutputTracks: (69 : 0x738b6b7fe8, 13) (68 : 0x7387b10fe8, 117)
  Stream volumes in dB: 0:-42, 1:-inf, 2:-inf, 3:-inf, 4:-14, 5:-inf, 6:-42, 7:-27, 8:-inf, 9:-96, 10:-15, 11:-14, 12:0, 13:0, 14:0
  Normal mixer raw underrun counters: partial=0 empty=0
  0 Tracks
  0 Effect Chains
...
Patches:
  ...
  Patch 316: No software bridge (thread 0x0 => thread 0x0) thread 0x738b6b7fe8 num sinks (1) first device type 00000001
  Patch 324: No software bridge (thread 0x0 => thread 0x0) thread 0x7387b10fe8 num sinks (1) first device type 00000080
...
System setParameters:
    ...
    08-19 14:52:03.274 UID  1000, 1 KVP received: A2dpSuspended=true
    08-19 14:52:03.279 UID  1000, 1 KVP received: LeAudioSuspended=true
    08-19 14:52:04.947 UID  1000, 1 KVP received: A2dpSuspended=false
    08-19 14:52:04.951 UID  1000, 1 KVP received: LeAudioSuspended=false
    08-19 14:52:04.965 UID  1000, 1 KVP received: A2dpSuspended=true
    08-19 14:52:30.248 UID  1000, 1 KVP received: A2dpSuspended=false
    08-19 14:53:14.667 UID  1000, 1 KVP received: screen_state=off
    08-19 14:53:14.843 UID  1000, 1 KVP received: screen_state=off
    08-19 15:06:08.070 UID  1000, 1 KVP received: screen_state=on
    08-19 15:06:08.434 UID  1000, 1 KVP received: screen_state=on
    08-19 15:07:11.095 UID  1000, 1 KVP received: screen_state=off
    08-19 15:07:11.290 UID  1000, 1 KVP received: screen_state=off
    08-19 15:10:39.673 UID  1000, 1 KVP received: screen_state=on
    08-19 15:10:40.025 UID  1000, 1 KVP received: screen_state=on
    08-19 15:11:50.096 UID  1000, 1 KVP received: screen_state=off
    08-19 15:11:50.256 UID  1000, 1 KVP received: screen_state=off
    08-19 15:18:22.833 UID  1000, 1 KVP received: screen_state=on
    08-19 15:18:23.220 UID  1000, 1 KVP received: screen_state=on
    08-19 15:18:25.375 UID  1000, 1 KVP received: screen_state=off
    08-19 15:18:25.580 UID  1000, 1 KVP received: screen_state=off
    08-19 15:26:22.344 UID  1000, 1 KVP received: screen_state=on
    08-19 15:26:22.718 UID  1000, 1 KVP received: screen_state=on
    08-19 15:26:33.728 UID  1000, 1 KVP received: screen_state=off
    08-19 15:26:33.918 UID  1000, 1 KVP received: screen_state=off
    08-19 15:28:52.403 UID  1000, 1 KVP received: screen_state=on
    08-19 15:28:52.769 UID  1000, 1 KVP received: screen_state=on
    08-19 15:28:54.135 UID  1000, 1 KVP received: screen_state=off
    08-19 15:28:54.333 UID  1000, 1 KVP received: screen_state=off
    08-19 15:37:04.747 UID  1000, 1 KVP received: screen_state=on
    08-19 15:37:05.103 UID  1000, 1 KVP received: screen_state=on
    08-19 15:37:06.590 UID  1000, 1 KVP received: screen_state=off
    08-19 15:37:06.787 UID  1000, 1 KVP received: screen_state=off

IAudioFlinger binder call profile:
1 createTrack n=7 ave=175.537 std=271.618 min=9.41984 max=610.865
...
20 setParameters n=53 ave=8.06481 std=27.9505 min=0.991191 max=201.911
22 registerClient n=26 ave=1.52318 std=3.33978 min=0.18123 max=13.2964
23 getInputBufferSize n=5 ave=3.23144 std=3.44123 min=0.530613 max=7.08338
34 newAudioUniqueId n=39 ave=0.0715556 std=0.0258899 min=0.026652 max=0.182999
35 acquireAudioSessionId n=42 ave=0.102872 std=0.155978 min=0.060845 max=1.08384
36 releaseAudioSessionId n=40 ave=0.100152 std=0.0932652 min=0.046076 max=0.548038
40 createEffect n=33 ave=12.4403 std=26.0707 min=3.33219 max=155.456
...
67 supportsBluetoothVariableLatency n=8 ave=0.164758 std=0.209107 min=0.059422 max=0.676498
69 isBluetoothVariableLatencyEnabled n=8 ave=0.0495756 std=0.015524 min=0.031537 max=0.070384
70 getSoundDoseInterface n=1 ave=0.140499 min=0.140499 max=0.140499
1598311760 dump n=7 ave=34.9636 std=26.9023 min=18.9566 max=95.4216
1598968902 getInterfaceDescriptor n=6 ave=0.0767293 std=0.0387245 min=0.040807 max=0.13269

IEffect binder call profile:
1 enable n=6 ave=0.0881267 std=0.0118816 min=0.071267 max=0.107883
3 command n=160 ave=0.481729 std=0.791316 min=0.106805 max=8.06954
4 disconnect n=32 ave=1.16469 std=0.738498 min=0.549422 max=3.27792
5 getCblk n=33 ave=0.0767841 std=0.0319393 min=0.049268 max=0.215153

DeviceHalHidl binder call profile:
createAudioPatch n=4 ave=0.470652 std=0.0607286 min=0.406345 max=0.547306
dump n=32 ave=2.05592 std=3.01312 min=0.230999 max=15.5773
getAudioPort n=8 ave=1.10105 std=1.38309 min=0.358268 max=4.48788
...
getParameters n=38 ave=0.534272 std=0.535347 min=0.142729 max=2.93623
initCheck n=4 ave=0.326316 std=0.190859 min=0.168306 max=0.604037
openInputStream n=6 ave=2.77063 std=2.41278 min=1.07896 max=7.06684
openOutputStream n=11 ave=2.41989 std=1.89165 min=1.03208 max=6.93427
releaseAudioPatch n=3 ave=2.02 std=2.30409 min=0.322306 max=4.64288
setConnectedState n=120 ave=0.595007 std=1.8632 min=0.004229 max=20.1188
...
setMode n=7 ave=48.6339 std=52.64 min=0.30919 max=119.054
setParameters n=212 ave=1.82225 std=13.7091 min=0.095961 max=198.061
setVoiceVolume n=3 ave=3.85746 std=3.12393 min=0.276922 max=6.02684
supportsAudioPatches n=59 ave=0.37272 std=0.46126 min=0.084268 max=2.59854

EffectHalHidl binder call profile:
close n=64 ave=0.40486 std=0.469367 min=0.087728 max=2.32938
command n=373 ave=1.13509 std=5.78792 min=0.087383 max=97.5868
dump n=16 ave=1.60586 std=2.43983 min=0.497384 max=10.096
getDescriptor n=33 ave=0.5251 std=0.870864 min=0.14446 max=4.86484
setInBuffer n=133 ave=0.00325965 std=0.00112659 min=0.001345 max=0.006152
setOutBuffer n=149 ave=0.00196982 std=0.00137355 min=0.001421 max=0.018345

StreamInHalHidl binder call profile:
dump n=6 ave=0.92903 std=0.82895 min=0.464999 max=2.60427
getAudioProperties n=24 ave=0.31464 std=0.312024 min=0.097499 max=1.72727
getBufferSize n=12 ave=0.360858 std=0.619948 min=0.074576 max=2.31519
getFrameSize n=6 ave=0.180735 std=0.0415528 min=0.128306 max=0.236538
setParameters n=4 ave=0.907662 std=0.554329 min=0.412768 max=1.50677
standby n=12 ave=0.288928 std=0.118267 min=0.146536 max=0.517691

StreamOutHalHidl binder call profile:
dump n=46 ave=1.19397 std=1.1181 min=0.285383 max=6.53227
getAudioProperties n=52 ave=0.294239 std=0.162962 min=0.122382 max=1.02031
getBufferSize n=26 ave=0.185639 std=0.0693204 min=0.075575 max=0.325306
getFrameSize n=11 ave=0.23446 std=0.0863504 min=0.143037 max=0.386113
getHalPid n=2 ave=0.514672 std=0.316649 min=0.290767 max=0.738576
getLatency n=180 ave=1.75323 std=4.7213 min=0.051538 max=38.1179
getParameters n=12 ave=0.482893 std=0.272112 min=0.231613 max=1.29511
legacyCreateAudioPatch n=36 ave=43.6986 std=72.9348 min=0.440805 max=289.103
setEventCallback n=15 ave=0.971201 std=1.47794 min=0.314537 max=6.16873
setParameters n=50 ave=31.7902 std=64.5582 min=0.335575 max=289.027
standby n=14 ave=15.7871 std=31.5727 min=0.109228 max=92.7608
updateSourceMetadata n=53 ave=0.623456 std=0.452324 min=0.192537 max=2.3115
...
analysis [  ]
timeout [  ]
pending [ { IAudioFlinger::dump scheduled 15:37:15.718 deadline :18.718 tid 7871 } ]
retired [ { IAudioFlinger::setParameters scheduled 15:37:06.590 deadline :09.590 tid 5169 } { DeviceHalHidl::setParameters scheduled 15:37:06.787 deadline  tid 5169 } { DeviceHalHidl::setParameters scheduled 15:37:06.788 deadline  tid 5169 } { DeviceHalHidl::setParameters scheduled 15:37:06.789 deadline  tid 5169 } { DeviceHalHidl::setParameters scheduled 15:37:06.789 deadline  tid 5169 } { IAudioFlinger::setParameters scheduled 15:37:06.787 deadline :09.787 tid 5169 } { StreamOutHalHidl::dump scheduled 15:37:15.719 deadline  tid 7871 } { StreamOutHalHidl::dump scheduled 15:37:15.721 deadline  tid 7871 } { StreamOutHalHidl::dump scheduled 15:37:15.722 deadline  tid 7871 } { StreamOutHalHidl::dump scheduled 15:37:15.725 deadline  tid 7871 } { EffectHalHidl::dump scheduled 15:37:15.727 deadline  tid 7871 } { StreamOutHalHidl::dump scheduled 15:37:15.728 deadline  tid 7871 } { DeviceHalHidl::dump scheduled 15:37:15.728 deadline  tid 7871 } { DeviceHalHidl::dump scheduled 15:37:15.733 deadline  tid 7871 } { DeviceHalHidl::dump scheduled 15:37:15.736 deadline  tid 7871 } { DeviceHalHidl::dump scheduled 15:37:15.738 deadline  tid 7871 } ]
...
waits: 1242
unlocks: 6587
avg_wait_ms: 25.142835
std_wait_ms: 68.649164
Capability: CommandThread_Mutex
locks: 10866
uncontested: 10787
waits: 79
unlocks: 10866
avg_wait_ms: 0.336025
std_wait_ms: 0.816441
...
waits: 16
unlocks: 1030
avg_wait_ms: 8.217053
std_wait_ms: 18.094087
Capability: DeviceEffectManager_Mutex
locks: 84
uncontested: 76
waits: 8
unlocks: 84
avg_wait_ms: 0.003870
std_wait_ms: 0.003027
...
waits: 245
unlocks: 85140
avg_wait_ms: 0.751251
std_wait_ms: 3.198713
Capability: AudioFlinger_ClientMutex
locks: 331
uncontested: 299
waits: 32
unlocks: 331
avg_wait_ms: 0.715650
std_wait_ms: 1.192185
Capability: EffectChain_Mutex
locks: 9243
uncontested: 9233
waits: 10
unlocks: 9243
avg_wait_ms: 0.001777
std_wait_ms: 0.000384
Capability: EffectBase_Mutex
locks: 1320
uncontested: 1288
waits: 32
unlocks: 1320
avg_wait_ms: 0.000951
std_wait_ms: 0.000975
Capability: AudioFlinger_HardwareMutex
locks: 172
uncontested: 164
waits: 8
unlocks: 172
avg_wait_ms: 0.001803
std_wait_ms: 0.000166
...
waits: 301
unlocks: 21371
avg_wait_ms: 0.015362
std_wait_ms: 0.015348
thread count: 24
tids without current activity [ 4876 4918 4919 4923 4986 4987 5056 5061 5063 5169 5721 5906 6907 7856 7869 7870 7871 7872 7887 10054 13283 14504 14921 14925 ]
...
AudioPolicyManager Dump: 0x71a0d4b790
  ...
  2. Port ID: 3; "Speaker"; {AUDIO_DEVICE_OUT_SPEAKER, @:}
   ...
   - Profiles (1):
      1. ""; AUDIO_FORMAT_PCM_16_BIT (0x1)
         ...
         AUDIO_ENCAPSULATION_TYPE_NONE
  3. Port ID: 51; "Bt Sco Headset"; {AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET, @:3C:B0:ED:D9:F5:5E}
     Encapsulation modes: 0, metadata types: 0
     "CMF Buds 2a"
   - Profiles (1):
      1. ""; AUDIO_FORMAT_PCM_16_BIT (0x1)
         ...
         channel masks: 0x0003
         AUDIO_ENCAPSULATION_TYPE_NONE
  4. Port ID: 46; "BT A2DP Out"; {AUDIO_DEVICE_OUT_BLUETOOTH_A2DP, @:3C:B0:ED:D9:F5:5E}
     Encapsulation modes: 0, metadata types: 0
     "CMF Buds 2a"
   - Profiles (1):
      1. ""; AUDIO_FORMAT_PCM_16_BIT (0x1)
  ...
  1. Port ID: 10; "Built-In Mic"; {AUDIO_DEVICE_IN_BUILTIN_MIC, @:bottom}
   ...
   - Profiles (1):
      1. ""; AUDIO_FORMAT_PCM_16_BIT (0x1)
         ...
         AUDIO_ENCAPSULATION_TYPE_NONE
  2. Port ID: 52; "Bt Sco Headset Mic"; {AUDIO_DEVICE_IN_BLUETOOTH_SCO_HEADSET, @:3C:B0:ED:D9:F5:5E}
     Encapsulation modes: 0, metadata types: 0
     "CMF Buds 2a"
   - Profiles (1):
      1. ""; AUDIO_FORMAT_PCM_16_BIT (0x1)
      ...
      1. "primary-out"; 0x0002 (AUDIO_OUTPUT_FLAG_PRIMARY)
       ...
       - Supported devices (8):
        ...
        5. "Bt Sco"; {AUDIO_DEVICE_OUT_BLUETOOTH_SCO, @:}
           Encapsulation modes: 0, metadata types: 0
        6. Port ID: 51; "Bt Sco Headset"; {AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET, @:3C:B0:ED:D9:F5:5E}
           Encapsulation modes: 0, metadata types: 0
           "CMF Buds 2a"
    ...
    15. "FM Mic"; {AUDIO_DEVICE_IN_FM_TUNER, @:}
      ...
      - Profiles (1):
         1. ""; AUDIO_FORMAT_PCM_16_BIT (0x1)
            ...
            AUDIO_ENCAPSULATION_TYPE_NONE
   - Dynamic devices (2):
    1. Port ID: 51; "Bt Sco Headset"; {AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET, @:3C:B0:ED:D9:F5:5E}
       Encapsulation modes: 0, metadata types: 0
       "CMF Buds 2a"
     - Profiles (1):
        1. ""; AUDIO_FORMAT_PCM_16_BIT (0x1)
      ...
      1. "a2dp output"; 0x0000 (AUDIO_OUTPUT_FLAG_NONE)
       - Profiles (3):
          ...
          3. ""; [dynamic format]; AUDIO_FORMAT_PCM_16_BIT (0x1)
             ...
             AUDIO_ENCAPSULATION_TYPE_NONE
       - Supported devices (3):
        1. Port ID: 46; "BT A2DP Out"; {AUDIO_DEVICE_OUT_BLUETOOTH_A2DP, @:3C:B0:ED:D9:F5:5E}
           Encapsulation modes: 0, metadata types: 0
           "CMF Buds 2a"
 ...
 Outputs (5):
  1. Port ID: 1; I/O handle: 13; IOProfile name:primary-out; Latency: 80; 0x0002 (AUDIO_OUTPUT_FLAG_PRIMARY)
   ...
   - Product Strategies (1):
      id 1015: - ActivityCount: 0, StopTime: 227498679606, 
   - Volume Activities (14):
      id 1: - ActivityCount: 0, StopTime: 227498679606, , Volume: -42.000, MuteCount: 00
  ...
  2. Port ID: 5; I/O handle: 21; IOProfile name:deep-buffer; Latency: 80; 0x0008 (AUDIO_OUTPUT_FLAG_DEEP_BUFFER)
   ...
   - Volume Activities (14):
      ...
      id 2: - ActivityCount: 0, StopTime: 0, , Volume: -758.000, MuteCount: 00
      id 3: - ActivityCount: 0, StopTime: 0, , Volume: -758.000, MuteCount: 00
      id 4: - ActivityCount: 0, StopTime: 0, , Volume: -5.100, MuteCount: 00
      id 5: - ActivityCount: 0, StopTime: 0, , Volume: -8.000, MuteCount: 00
      id 6: - ActivityCount: 0, StopTime: 0, , Volume: -758.000, MuteCount: 00
  ...
  3. Port ID: 7; I/O handle: 29; IOProfile name:fast; Latency: 50; 0x0004 (AUDIO_OUTPUT_FLAG_FAST)
   ...
   - Volume Activities (14):
      id 1: - ActivityCount: 0, StopTime: 0, , Volume: 0.000, MuteCount: 00
      id 2: - ActivityCount: 0, StopTime: 0, , Volume: -758.000, MuteCount: 00
      id 3: - ActivityCount: 0, StopTime: 0, , Volume: -758.000, MuteCount: 00
      id 4: - ActivityCount: 0, StopTime: 0, , Volume: 0.000, MuteCount: 00
      id 5: - ActivityCount: 0, StopTime: 0, , Volume: -8.000, MuteCount: 00
      ...
      id 7: - ActivityCount: 0, StopTime: 0, , Volume: -42.000, MuteCount: 00
      id 8: - ActivityCount: 0, StopTime: 0, , Volume: -11.118, MuteCount: 00
      id 9: - ActivityCount: 0, StopTime: 191372757286, , Volume: 0.000, MuteCount: 00
      id 10: - ActivityCount: 0, StopTime: 0, , Volume: 0.000, MuteCount: 01
      id 11: - ActivityCount: 0, StopTime: 0, , Volume: 0.000, MuteCount: 00
      id 12: - ActivityCount: 0, StopTime: 0, , Volume: 0.000, MuteCount: 00
      id 13: - ActivityCount: 0, StopTime: 0, , Volume: 0.000, MuteCount: 00
   ...
   - AudioTrack clients (1):
      1. Port ID: 24; Session ID: 201; uid 1001; State: Inactive
         ...
         DAP Primary Mix: 0x0
  4. Port ID: 48; I/O handle: 117; IOProfile name:a2dp output; Latency: 256; 0x0000 (AUDIO_OUTPUT_FLAG_NONE)
   ...
   - Volume Activities (14):
      ...
      id 13: - ActivityCount: 0, StopTime: 0, , Volume: 0.000, MuteCount: 00
      id 14: - ActivityCount: 0, StopTime: 0, , Volume: 0.000, MuteCount: 00
  5. Port ID: 50; I/O handle: 125; Latency: 256; 0x0000 (AUDIO_OUTPUT_FLAG_NONE)
     AUDIO_FORMAT_PCM_16_BIT; 44100; Channel mask: 0x3
 ...
 - Effects (1):
  1. Effect ID: 11; Attached to I/O handle: 117; Session: 0;
     Music Effect? yes; "DAX3_S_3.7.2.0_r1"; Disabled; Active

 Audio Patches (4):
  1. owner uid 1041; handle  4; af handle 316
  ...
  3. owner uid 1041; handle  8; af handle 244
     ...
     [sink 1] Device Port ID: 2; {AUDIO_DEVICE_OUT_EARPIECE, @:}
  4. owner uid 1041; handle 49; af handle 324
     [src  1] Mix Port ID: 48; I/O handle: 117;
     [sink 1] Device Port ID: 46; {AUDIO_DEVICE_OUT_BLUETOOTH_A2DP, @:3C:B0:ED:D9:F5:5E}
...
2 setDeviceConnectionState n=21 ave=130.09 std=124.469 min=10.3816 max=442.957
5 setPhoneState n=6 ave=386.321 std=127.567 min=239.043 max=578.37
6 setForceUse n=35 ave=0.437158 std=1.21652 min=0.052884 max=7.18319
8 getOutput n=4 ave=0.689883 std=0.0919349 min=0.591459 max=0.778691
17 setDeviceAbsoluteVolumeEnabled n=39 ave=8.76497 std=51.7727 min=0.134614 max=323.766
18 initStreamVolume n=11 ave=0.0863066 std=0.00730536 min=0.079538 max=0.105153
19 setStreamVolumeIndex n=2009 ave=1.67638 std=10.31 min=0.382614 max=443.63
...
26 getDevicesForAttributes n=532 ave=10.0678 std=48.5452 min=0.161767 max=520.328
32 isStreamActive n=21 ave=1.33078 std=2.48155 min=0.047305 max=10.2637
33 isStreamActiveRemotely n=6 ave=0.793979 std=1.35223 min=0.059921 max=3.47673
40 setSupportedSystemUsages n=1 ave=0.079152 min=0.079152 max=0.079152
42 getOffloadSupport n=4 ave=0.131777 std=0.0219265 min=0.111421 max=0.158729
44 listAudioPorts n=804 ave=18.765 std=51.8319 min=0.038422 max=465.784
49 listAudioPatches n=782 ave=8.69225 std=40.5549 min=0.033652 max=358.385
51 registerClient n=21 ave=0.332918 std=0.637763 min=0.105498 max=2.96577
52 setAudioPortCallbacksEnabled n=40 ave=0.0547958 std=0.0209671 min=0.023537 max=0.120614
53 setAudioVolumeGroupCallbacksEnabled n=21 ave=0.0522145 std=0.0421006 min=0.01596 max=0.211845
...
71 getHwOffloadFormatsSupportedForBluetoothMedia n=4 ave=29.4274 std=58.5597 min=0.128998 max=117.267
...
80 listAudioProductStrategies n=11 ave=5.56764 std=15.4669 min=0.255806 max=52.1185
81 getProductStrategyFromAudioAttributes n=2 ave=0.126537 std=0.0184399 min=0.113498 max=0.139576
...
86 setDevicesRoleForStrategy n=6 ave=154.157 std=57.495 min=98.4047 max=219.479
88 clearDevicesRoleForStrategy n=6 ave=79.4081 std=113.668 min=7.93934 max=272.653
95 registerSoundTriggerCaptureStateListener n=1 ave=0.231691 min=0.231691 max=0.231691
1598311760 dump n=7 ave=10.0217 std=5.14051 min=6.14108 max=19.2674
1598968902 getInterfaceDescriptor n=6 ave=0.0562482 std=0.013217 min=0.042921 max=0.072113

[16] SETTINGS BLUETOOTH
============================================================
airplane_mode_radios=cell,bluetooth,uwb,wifi,wimax
airplane_mode_toggleable_radios=bluetooth,wifi
bluetooth_a2dp_codec_priority=1000
bluetooth_a2dp_codec_sample_rate=48000
...
ANALYSIS FINISHED
OUTPUT FILE:
C:\Users\mobina\Desktop\desktop\a217 roms\A21S_VENDOR_WORK\A21S_ANALYSIS.txt
============================================================
